...
mocha.describe('************* TEST EVENT ROUTES *************', function () {
  mocha.describe('Preparation', function () {
    mocha.it(
      'First, create a user for use to test the authentication',
      function (done) {
        chai
          .request(server)
          .post('/register')
    ...
    mocha.it('Second, create two contacts for use ', function (done) {
      chai
        .request(server)
        .post('/contact')
  ...
  mocha.describe(
    ...
    () => {
      ...
      mocha.it(
        'it should not give access to SEARCH without a verified token ',
        function (done) {
          chai
            .request(server)
            .get('/event/search')
    ...
    () => {
      ...
      */
      ...
      mocha.describe('/POST route', () => {
        mocha.it(
          'it should not POST an event without name field',
          function (done) {
            chai
              .request(server)
              .post('/event')
      ...
      mocha.describe('/GET/getall route', function () {
        mocha.it(
          'it should GET all the events of a given user',
          function (done) {
            chai
              .request(server)
              .get('/event/getall')
