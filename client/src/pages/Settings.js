...
function Settings() {
    ...
    return (
        <Box sx={{ display: 'flex' }}>
            ...
            <Box sx={{ display: 'flex', flexGrow: { xs: 0, sm: 1 }, justifyContent: 'center', background: '#F7F7F7', height: '100vh' }} >
                {
                    user !== undefined &&
                    <Box sx={{ display: 'flex', width: { sm: '80vw', xl: '60vw' }, flexDirection: 'column', padding: '10%' }}>
