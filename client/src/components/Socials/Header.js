...
import { Box, Stack, Paper, InputBase, IconButton, Typography, Select, MenuItem } from '@mui/material'

import AddIcon from '@mui/icons-material/Add'
import PillTab from './PillTabs'

function Header({ sortBy, setSortBy, setSearch, handleClickOpen, tab, handleTabChange }) {
    return (
        <Box>
            <Stack
                sx={{
